...
<head>
  ...
  * Template URL: https://bootstrapmade.com/iportfolio-bo</div>otstrap-portfolio-websites-template/
...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">Alain Guigma</a></h1>
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="#hero" class="nav-link scrollto active"><i class="bi bi-file-earmark-break-fill"></i> <span>Dashboard</span></a></li>
          <li><a href="#about" class="nav-link scrollto"><i class="bx bx-home"></i> <span>Acceuil</span></a></li>
          <li><a href="#resume" class="nav-link scrollto"><i class="bi bi-card-text"></i> <span>Ajouter Comptes</span></a></li>
          <li><a href="#portfolio" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Ajouter Notes</span></a></li>
          <li><a href="#services" class="nav-link scrollto"><i class="bi bi-card-checklist"></i> <span>Voir Notes</span></a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Alain Guigma</h1>
      <p>Je suis <span class="typed" data-typed-items="Designeur, Developeur, Freelance, Photographe"></span></p>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Le Directeur du lycée qui est le super administrateur de l'application pourra ajouter le proffesseur principal ainsi que les élèves du lycée voir les notes ...</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Directeur Général &amp; Super Administrateur.</h3>
            <p class="font-italic">
              Bibliographie du Directeur Général du lycée ainsi que ces compétences et son niveau dans les domaines des études
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Date de naissance:</strong> <span>1 Mai 1995</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Site Web:</strong> <span>www.example.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Numéro:</strong> <span>+226 71406288</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Ville:</strong> <span>Ouagadougou,Burkina Faso</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>30</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Niveau:</strong> <span>Elévé</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Adresse mail:</strong> <span>email@example.com</span></li>
            ...
            <p>
                ...
                toutes sortes, ébranlés dans leur autorité et assurance.
            </p>
          </div>
        </div>
    ...
    <section id="resume" class="resume ">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Ajouter Comptes</h2>
          <p>Ce formulaire permettra au Directeur Générale d'ajouter le compte du proffesseur principal ainsi que pour les élèves pour qu'ils aient accès au plateforme</p>
        </div>

        <div class="page-wrapper bg-white  font-poppins">
            <div class="wrapper wrapper--w780">
                <div class="card card-3">
                    <div class="card-heading"></div>
                    <div class="card-body">
                        <h2 class="title">Ajouter Utilisateurs</h2>
                        <form action="{{route('ajout')}}" method="POST">
                            ...
                            <div class="input-group">
                                <input class="input--style-3" type="text" placeholder="Classe" name="classe">
                                <span class="text-danger">@error ('classe'){{ $message }} @enderror</span>
                            </div>
                            <div class="p-t-10">
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Ajouter Notes</h2>
          <p>Ce formulaire permettra au Directeur Général ainsi qu'aux Professeurs Principaux d'insérer les notes des élèves pour permettre aux élèves d'avoir accès une fois connecter</p>
        </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Gestion Notes</span></strong>
      </div>
      <div class="credits">
